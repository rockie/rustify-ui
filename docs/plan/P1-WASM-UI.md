...
- **M3 现状**：调度与投递骨架完成，第二份示例已跑通主路径。
  ...
  - 未做：V2 剩下的规模项（10,000 个带序号动作、120 Hz 移动夹杂 20 次点击）。`Pace::Continuous` 已实现并有单测，但还没有真实生产者，拖拽会是第一个。
