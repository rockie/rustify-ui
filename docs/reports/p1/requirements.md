...
| R33 reliability over time | partial | Endurance at ten actions a second: nothing lost, duplicated or late. Which duration was run is in [the performance report](performance.md) | M8 |
