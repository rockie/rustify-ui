...
| R35 accessibility | partial | The tree over both large loads is correct and checked — row indices, one tab stop, query entries, keyboard reach. The VoiceOver walkthrough (A-4) was **waived by the user on 2026-09-13** and not performed; screen-reader support is not claimed | [accessibility](accessibility.md) |
...
| R40 acceptance | partial (P3 closed; full PRD deferred) | `cargo xtask verify --suite p3` with 0 automated failures, two clean builds of each of four examples, these six reports and this matrix. A-4 waived by the user, recorded as untested | [M8](../../validation/p3/m8.md) |
...
| NFR-4 compatibility and usability | §6.2, §9.4 | Partial: the matrix is unchanged; A-4 waived by the user on 2026-09-13 and recorded as untested |
...
| A-4 acceptance resources | §9.4 | **Closed by waiver, 2026-09-13.** The user chose to waive rather than perform; recorded as untested, never as a pass |
